...
public class AutomatedUserScreen extends BasicContainerScreen<AutomatedUserContainer>
{
	public AutomatedUserScreen(AutomatedUserContainer screenContainer, PlayerInventory inv, ITextComponent titleIn)
	{
